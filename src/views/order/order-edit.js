...
export default function OrderEdit() {
  ...
  function fetchOrder() {
    ...
    orderService
      ...
      .then((res) => {
        ...
        form.setFieldsValue({
          delivery_time:
            order?.delivery_time && moment(order?.delivery_time, 'HH:mm:ss'),
          delivery_date:
            order?.delivery_date && moment(order?.delivery_date, 'YYYY-MM-DD'),
  ...
  const onFinish = (values) => {
    ...
    const body = {
      ...
      address: {
        address: activeMenu.data.addressData?.address || undefined,
        office: undefined,
        house: undefined,
        floor: undefined,
      },
